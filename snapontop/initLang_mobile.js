...
CursorMorph.prototype.initializeClipboardHandler = function () {
    ...
    this.clipboardHandler.style.left = '-300px';
    ...
    setTimeout("document.getElementById('mClipHandler').focus()",200);
...
IDE_Morph.prototype.init = function (lan) {
    ...
    this.stageRatio = 0.2; // for IDE animations, e.g. when zooming
